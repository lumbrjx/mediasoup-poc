...
// room creation logic will be handleled later
rooms[roomName] = {
...
async function runSocketServer(webServer) {
	...
	socketServer.on('connection', (socket) => {
		...
		socket.on('producerClose', async (_data, callback) => {
...
function getTransport(socketId, isDataChannel) {
	console.log("Getting transport with socketId = " + socketId + " and dataChannel = ")
